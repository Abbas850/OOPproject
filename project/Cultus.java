...
public class Cultus extends javax.swing.JFrame {
...
private boolean checkF;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Price For Suzuki Cultus is 1410,000");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/project/Suzuki_cultus.jpg"))); // NOI18N
 ...
 private boolean checkCard(){
    ...
    private void prchaseCarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_prchaseCarActionPerformed
        double down = (10 / 100.0) * 1410000;
        if(check && checkF){
            JFrame window = new JFrame();
            window.setSize(700, 300);
            window.setVisible(true);
            window.setLocationRelativeTo(null);
            double fort = (25 / 100.0) * 1410000;
            double monthly = (1410000- fort) / 60;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cultus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
